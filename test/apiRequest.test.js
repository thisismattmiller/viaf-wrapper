...
describe('apiRequest', function () {
	...
	it('buildSearchUrl - default', function (done) {
		...
		r.should.equal('http://viaf.org/viaf/search?query=cql.any+all+"hithere"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})
	...
	it('buildSearchUrl - operators - ONE_OR_MORE', function (done) {
		...
		r.should.equal('http://viaf.org/viaf/search?query=cql.any+%3D+"hithere"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})
	...
	it('buildSearchUrl - operators - EXACT', function (done) {
		...
		r.should.equal('http://viaf.org/viaf/search?query=cql.any+exact+"hithere"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})

	it('buildSearchUrl - operators - ANY', function (done) {
		var r = apiRequest.buildSearchUrl('searchAny','hithere',{operator: apiRequest.ANY })
		r.should.equal('http://viaf.org/viaf/search?query=cql.any+any+"hithere"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})
	...
	it('buildSearchUrl - operators - LESS', function (done) {
		...
		r.should.equal('http://viaf.org/viaf/search?query=cql.any+%3C+"hithere"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})
	...
	it('buildSearchUrl - operators - LESS_EQUAL', function (done) {
		...
		r.should.equal('http://viaf.org/viaf/search?query=cql.any+%3C%3D+"hithere"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})
	...
	it('buildSearchUrl - operators - GRATER', function (done) {
		...
		r.should.equal('http://viaf.org/viaf/search?query=cql.any+%3E+"hithere"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})
	...
	it('buildSearchUrl - operators - GRATER_EQUAL', function (done) {
		...
		r.should.equal('http://viaf.org/viaf/search?query=cql.any+%3E%3D+"hithere"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})

	it('buildSearchUrl - operators - NOT', function (done) {
		var r = apiRequest.buildSearchUrl('searchAny','hithere',{operator: apiRequest.NOT })
		r.should.equal('http://viaf.org/viaf/search?query=cql.any+not+"hithere"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})

	it('buildSearchUrl - record start', function (done) {
		var r = apiRequest.buildSearchUrl('searchAny','hithere',{start: 11})
		r.should.equal('http://viaf.org/viaf/search?query=cql.any+all+"hithere"&sortKeys=holdingscount&maximumRecords=50&startRecord=11&httpAccept=application/xml')
		done()
	})
	...
	it('buildSearchUrl - type - searchServerChoice', function (done) {
		...
		r.should.equal('http://viaf.org/viaf/search?query=cql.serverChoice+all+"hithere"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})

	it('buildSearchUrl - type - searchCorporate', function (done) {
		var r = apiRequest.buildSearchUrl('searchCorporate','hithere',{})
		r.should.equal('http://viaf.org/viaf/search?query=local.corporateNames+all+"hithere"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})

	it('buildSearchUrl - type - searchGeographic', function (done) {
		var r = apiRequest.buildSearchUrl('searchGeographic','hithere',{})
		r.should.equal('http://viaf.org/viaf/search?query=local.geographicNames+all+"hithere"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})

	it('buildSearchUrl - type - searchLCCN', function (done) {
		var r = apiRequest.buildSearchUrl('searchLCCN','hithere',{})
		r.should.equal('http://viaf.org/viaf/search?query=local.LCCN+all+"hithere"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})

	it('buildSearchUrl - type - searchPreferredName', function (done) {
		var r = apiRequest.buildSearchUrl('searchPreferredName','hithere',{})
		r.should.equal('http://viaf.org/viaf/search?query=local.mainHeadingEl+all+"hithere"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})

	it('buildSearchUrl - type - searchNames', function (done) {
		var r = apiRequest.buildSearchUrl('searchNames','hithere',{})
		r.should.equal('http://viaf.org/viaf/search?query=local.names+all+"hithere"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})

	it('buildSearchUrl - type - searchPersonalNames', function (done) {
		var r = apiRequest.buildSearchUrl('searchPersonalNames','hithere',{})
		r.should.equal('http://viaf.org/viaf/search?query=local.personalNames+all+"hithere"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})

	it('buildSearchUrl - type - searchSourceRecord', function (done) {
		var r = apiRequest.buildSearchUrl('searchSourceRecord','hithere',{})
		r.should.equal('http://viaf.org/viaf/search?query=local.source+all+"hithere"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})

	it('buildSearchUrl - type - searchTitle', function (done) {
		var r = apiRequest.buildSearchUrl('searchTitle','hithere',{})
		r.should.equal('http://viaf.org/viaf/search?query=local.title+all+"hithere"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})

	it('buildSearchUrl - type - searchExpression', function (done) {
		var r = apiRequest.buildSearchUrl('searchExpression','hithere',{})
		r.should.equal('http://viaf.org/viaf/search?query=local.uniformTitleExpressions+all+"hithere"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})

	it('buildSearchUrl - type - searchWorks', function (done) {
		var r = apiRequest.buildSearchUrl('searchWorks','hithere',{})
		r.should.equal('http://viaf.org/viaf/search?query=local.uniformTitleWorks+all+"hithere"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})
	...
	it('buildSearchUrl - source limit - VAIF', function (done) {
		...
		r.should.equal('http://viaf.org/viaf/search?query=cql.any+all+"hithere"+and+local.sources+%3D+"viaf"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})
	...
	it('buildSearchUrl - source limit - AUSTRALIA', function (done) {
		...
		r.should.equal('http://viaf.org/viaf/search?query=cql.any+all+"hithere"+and+local.sources+%3D+"nla"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})
	...
	it('buildSearchUrl - source limit - BELGIUM', function (done) {
		...
		r.should.equal('http://viaf.org/viaf/search?query=cql.any+all+"hithere"+and+local.sources+%3D+"vlacc"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})
	...
	it('buildSearchUrl - source limit - CANADA', function (done) {
		...
		r.should.equal('http://viaf.org/viaf/search?query=cql.any+all+"hithere"+and+local.sources+%3D+"lac"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})
	...
	it('buildSearchUrl - source limit - CZECH', function (done) {
		...
		r.should.equal('http://viaf.org/viaf/search?query=cql.any+all+"hithere"+and+local.sources+%3D+"nkc"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})
	...
	it('buildSearchUrl - source limit - EGYPT', function (done) {
		...
		r.should.equal('http://viaf.org/viaf/search?query=cql.any+all+"hithere"+and+local.sources+%3D+"egaxa"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})
	...
	it('buildSearchUrl - source limit - FRANCE_BNF', function (done) {
		...
		r.should.equal('http://viaf.org/viaf/search?query=cql.any+all+"hithere"+and+local.sources+%3D+"bnf"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})
	...
	it('buildSearchUrl - source limit - FRANCE_SUDOC', function (done) {
		...
		r.should.equal('http://viaf.org/viaf/search?query=cql.any+all+"hithere"+and+local.sources+%3D+"sudoc"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})
	...
	it('buildSearchUrl - source limit - GERMANY', function (done) {
		...
		r.should.equal('http://viaf.org/viaf/search?query=cql.any+all+"hithere"+and+local.sources+%3D+"dnb"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})
	...
	it('buildSearchUrl - source limit - GETTY', function (done) {
		...
		r.should.equal('http://viaf.org/viaf/search?query=cql.any+all+"hithere"+and+local.sources+%3D+"jpg"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})
	...
	it('buildSearchUrl - source limit - HUNGARY', function (done) {
		...
		r.should.equal('http://viaf.org/viaf/search?query=cql.any+all+"hithere"+and+local.sources+%3D+"nszl"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})
	...
	it('buildSearchUrl - source limit - ISRAEL', function (done) {
		...
		r.should.equal('http://viaf.org/viaf/search?query=cql.any+all+"hithere"+and+local.sources+%3D+"nliara"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})
	...
	it('buildSearchUrl - source limit - ITALY', function (done) {
		...
		r.should.equal('http://viaf.org/viaf/search?query=cql.any+all+"hithere"+and+local.sources+%3D+"iccu"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})

	it('buildSearchUrl - source limit - LOC', function (done) {
		var r = apiRequest.buildSearchUrl('searchAny','hithere',{limit : apiRequest.LOC})
		r.should.equal('http://viaf.org/viaf/search?query=cql.any+all+"hithere"+and+local.sources+%3D+"lc"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})
	...
	it('buildSearchUrl - source limit - NORWAY', function (done) {
		...
		r.should.equal('http://viaf.org/viaf/search?query=cql.any+all+"hithere"+and+local.sources+%3D+"bibsys"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})
	...
	it('buildSearchUrl - source limit - POLAND', function (done) {
		...
		r.should.equal('http://viaf.org/viaf/search?query=cql.any+all+"hithere"+and+local.sources+%3D+"nukat"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})
	...
	it('buildSearchUrl - source limit - PORTUGAL', function (done) {
		...
		r.should.equal('http://viaf.org/viaf/search?query=cql.any+all+"hithere"+and+local.sources+%3D+"ptbnp"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})
	...
	it('buildSearchUrl - source limit - SPAIN', function (done) {
		...
		r.should.equal('http://viaf.org/viaf/search?query=cql.any+all+"hithere"+and+local.sources+%3D+"bne"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})
	...
	it('buildSearchUrl - source limit - SWEDEN', function (done) {
		...
		r.should.equal('http://viaf.org/viaf/search?query=cql.any+all+"hithere"+and+local.sources+%3D+"selibr"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})
	...
	it('buildSearchUrl - source limit - SWISS_NL', function (done) {
		...
		r.should.equal('http://viaf.org/viaf/search?query=cql.any+all+"hithere"+and+local.sources+%3D+"swnl"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})
	...
	it('buildSearchUrl - source limit - SWISS_RERO', function (done) {
		...
		r.should.equal('http://viaf.org/viaf/search?query=cql.any+all+"hithere"+and+local.sources+%3D+"rero"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})
	...
	it('buildSearchUrl - source limit - RUSSIA', function (done) {
		...
		r.should.equal('http://viaf.org/viaf/search?query=cql.any+all+"hithere"+and+local.sources+%3D+"rsl"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})
	...
	it('buildSearchUrl - source limit - VATICAN', function (done) {
		...
		r.should.equal('http://viaf.org/viaf/search?query=cql.any+all+"hithere"+and+local.sources+%3D+"bav"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})

	it('buildSearchUrl - source limit - XA', function (done) {
		var r = apiRequest.buildSearchUrl('searchAny','hithere',{limit : apiRequest.XA})
		r.should.equal('http://viaf.org/viaf/search?query=cql.any+all+"hithere"+and+local.sources+%3D+"xa"&sortKeys=holdingscount&maximumRecords=50&startRecord=1&httpAccept=application/xml')
		done()
	})
